...
export default function Planner() {
  ...
  return (
    <div className="mt-[80px] pt-[40px] w-full relative bg-gray-50/50">
      {/* 모바일: 네비게이션 토글 버튼 */}
      <div className="sm:hidden">
        <button
          onClick={() => setIsNavOpen((prev) => !prev)}
          className="w-10 h-20 absolute z-20 top-60 left-0 bg-[#fff2ec] text-[#e84500] rounded-tr-lg rounded-br-lg flex flex-col items-center justify-center"
        >
      ...
      <div className="max-w-[1400px] w-full flex items-start justify-center mx-auto relative bg-white">
        {/* 데스크톱: 항상 보이는 네비게이션 */}
        <div className="hidden sm:block w-[250px] h-[800px] border-r border-r-gray-100 ">
          {/* 여기에 네비게이션 내용 */}
          <div></div>
        </div>

        {/* 플래너 화면 */}
        <div className="w-full sm:w-[1150px] h-[800px]  ">
